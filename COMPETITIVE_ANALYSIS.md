# Competitive Analysis for 1.0.0

This document summarizes the projects closest to Scaffolder's 1.0.0 scope and
...
platforms. The stable 1.0.0 promise is narrower: deterministic React, Vue, and
Next.js project generation with preview, documented support boundaries, and
production deployment for the generator itself.

## Comparable Projects

| Project | Primary strength | Gap Scaffolder can target |
| --- | --- | --- |
| Vite / create-vite | Fast official scaffolding for many frontend templates. | CLI-first, minimal cross-option preview, and no Scaffolder-specific support matrix. |
